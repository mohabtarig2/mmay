              ...
              <tbody>
                  ...
                  <tr v-for="(data,index) in details.data" :key="index">
                      ...
                      <td class="project-actions text-right">
                          ...
                          <router-link class="btn btn-primary btn-sm" :to="{name:'StoneAdminDtails',params: { id: data.id }}" target="_blank">
...
export default {
    ...
    methods: {
            detailsTender(page =1){
                axios.get('/admin/detailsTenderStone?page=' + page).then(res=>{
