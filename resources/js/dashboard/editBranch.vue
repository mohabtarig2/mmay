<template>
  <div class="container mt-3 text-right" dir="rtl">
    <div class="p-descrip-box">
      ...
      <div v-if="user.company.emirates == 7">ابوظبي الفرع الرئيسي</div>
      <div v-else>
        <div v-if="TypeEmirates7 == 7">
          (فرع) ابوظبي
          <status :status="status7"></status>
        </div>

        <div v-else>
          <label class="checkbox d-block" :dir="$t('directions')">
      ...
      <div v-if="user.company.emirates == 1">دبي الفرع الرئيسي</div>
      <div v-if="TypeEmirates1 == 1">
        (فرع) دبي
        <status :status="status1"></status>
      </div>
 ...
 <div v-if="user.company.emirates == 5"> الشارقة الفرع الرئيسي</div>
 <div v-else>
       <div v-if="TypeEmirates5 == 5">
          (فرع) الشارقة
          <status :status="status5"></status>
        </div>
        <div v-else>
      <label
        class="checkbox d-block"
        :dir="$t('directions')"
        v-if="user.company.emirates != 5"
      >
        <input type="checkbox" v-model="sharjah" />
        <span class="check"></span>
        <span class="mr-4 ml-4"> الشارقة</span>
      </label>
      <div class="" v-if="sharjah == true">
   ...
   <div v-if="user.company.emirates == 6"> عجمان الفرع الرئيسي</div>
<div v-else>

   <div v-if="TypeEmirates6 == 6">
          (فرع) عجمان
          <status :status="status6"></status>
        </div>
  <div v-else>
      <label
        class="checkbox d-block"
        :dir="$t('directions')"
        v-if="user.company.emirates != 6"
      >
   ...
   <div v-if="user.company.emirates == 4"> ام القيوين الفرع الرئيسي</div>
<div v-else>

   <div v-if="TypeEmirates4 == 4">
          (فرع) ام القيوين
          <status :status="status4"></status>
        </div>
  <div v-else>
      <label
        class="checkbox d-block"
        :dir="$t('directions')"
        v-if="user.company.emirates != 4"
      >
 ...
 <div v-if="user.company.emirates == 3">  راس الخيمة الفرع الرئيسي</div>
<div v-else>

   <div v-if="TypeEmirates3 == 3">
          (فرع) راس الخيمة
          <status :status="status3"></status>
        </div>
  <div v-else>
      <label
        class="checkbox d-block"
        :dir="$t('directions')"
        v-if="user.company.emirates != 3"
      >
   ...
   <div v-if="user.company.emirates == 2"> فجيرة  الفرع الرئيسي</div>
<div v-else>

   <div v-if="TypeEmirates2 == 2">
          (فرع)  الفجيرة
  ...
  <div v-else>
      ...
      <div class="" v-if="fujairah == true" >
        <h5 class="text-right">رخصة  الفجيرة</h5>
        <div class="">
          <label class="d-block">
            <span
              class="btn btn-secondary"
