        ...
        <button type="button" class="btn btn-light confirm mr-3" data-dismiss="modal">لا</button>
                ...
                <div class="row container mt-5 c-form-inner">
                  <div class="col-md-6 form-group col-sm-12">
                    <div class="container font-weight-bold">التصميم </div>
                    <input
                      class="form-control"
                      placeholder="1,000"
            ...
            <b> 12,000  </b>
                  ...
                  <div class="col-md-6 form-group col-sm-12">
                    <div class="container font-weight-bold">الأشراف/ شهرياٌ
                    </div>
            ...
            <b> 1,000  </b>
                  ...
                  <div class="col-md-6 form-group col-sm-12">
                    <div class="container font-weight-bold">مساحة البناء  </div>
                    <input
                      class="form-control"
...
,'is-invalid':checkTab =='false',},
        ...
        <div v-if="checkTab=='false'"   
            ...
            قدم مربع
                  ...
                  <div class="col-md-6 form-group col-sm-12">
                    <div class="container font-weight-bold">الميزانية</div>
            ...
            <b> 1,000,000   </b>
             درهم
                ...
                <div class="form-group container">
                  <div class="container">االمقترح </div>
                  <textarea
                    class="form-control"
