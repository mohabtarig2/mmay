                  ...
                  <div class="card ">
                    ...
                    <div class="card-body">
                      ...
                      <div class="comment-box " style="position: relative">
                        ...
                        <div class="content-name-comment " style="position: absolute ;   left: 58px;top: -2px;">
                        <span class="d-block text-o"> <b>Bo  Tahnon</b></span>
                        <small style="font-size:10px">12/11/2020</small>

                        </div>
                        <p class="text muted mt-3 ml-5">

Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatum commodi placeat, quidem cum dignissimos, aliquam nihil sapiente, quisquam architecto a quia. Voluptatum quia placeat corporis officia possimus consectetur. Amet, in.
                        </p>
                      ...
                      <div class="comment-box " style="position: relative">
                        <img src="https://via.placeholder.com/50" class="rounded-circle">
                        <div class="content-name-comment " style="position: absolute ;   left: 58px;top: -2px;">
                        <span class="d-block text-o"> <b>Ibrahim abdo </b></span>
                        <small style="font-size:10px">12/11/2020</small>
